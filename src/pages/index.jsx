  ...
  <React.Fragment>
    ...
    <Parallax pages={4}>
      ...
      <Content speed={0.4} offset={0}>
        <Hero>
          <BigTitle>
            Hola, <br /> Soy David Hernández.
          </BigTitle>
          <Subtitle>Este es un blog personal en el hay información sobre mí.</Subtitle>
        </Hero>
      </Content>
      <DividerMiddle bg="linear-gradient(to right, SlateBlue 0%, DeepSkyBlue 100%)" speed={-0.2} offset={1.1} />
      <Content speed={0.4} offset={1}>
        <Inner>
          <Title>Sobre mi experiencia profesional</Title>
          <ProjectsWrapper>
            <ProjectCard
              title="Gisnet - Backend Developer"
              link="https://www.behance.net/gallery/58937147/Freiheit"
              bg="#D4145A"
            >
              ¡Mi actual trabajo donde me enfrento a nuevos retos con JAVA! : )
            </ProjectCard>
            <ProjectCard
              title="Velas Resorts - Backend Developer"
              link="https://www.behance.net/gallery/52915793/Harry-Potter"
              bg="linear-gradient(to right, #D4145A 0%, #FBB03B 100%)"
            >
              ¡Un excelente trabajo donde terminé por convencerme que esto era lo mío!
            </ProjectCard>
      ...
      <Content speed={0.4} offset={2}>
        <Inner>
          ...
          <AboutHero>
            <Avatar src={avatar} alt="David Hernández" />
            <AboutSub>
      ...
      <Content speed={0.4} offset={3}>
        <Inner>
          ...
          <ContactText>
            Escríbeme mediante <a href="mailto:david.hdez.270792@gmail.com">Email</a> o encuentrame en otras redes sociales:{' '}
            <a href="https://www.facebook.com/TourleRz">Facebook</a> o{' '}
            <a href="https://www.instagram.com/tourl/">Instagram</a>
          </ContactText>
        </Inner>
        <Footer>
